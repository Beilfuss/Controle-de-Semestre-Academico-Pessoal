...
class TelaDadosAula():
    ...
    def __init__(self, controlador_aula):
        ...
        self.__janela = None
        self.inicializar_componentes(dados_aula={"sala": "", "dia": "", "horarios": ""})
    ...
    def inicializar_componentes(self, dados_aula):
        ...
        layout = [
            ...
            [sg.Text("Dia*"), sg.Radio('Segunda-feira', "RADIO1", size=(10, 1), key='Segunda-feira'), sg.Radio('Quarta-feira', "RADIO1", key='Quarta-feira'), sg.Radio('Sexta-feira', "RADIO1", key='Sexta-feira'), sg.Radio('Terça-feira', "RADIO1", key='Terça-feira', size=(10, 1)), sg.Radio('Quinta-feira', "RADIO1", key='Quinta-feira'), sg.Radio('Sábado', "RADIO1", key='Sábado')],
