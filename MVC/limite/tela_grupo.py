...
class TelaGrupo:
    ...
    def inicializar_componentes(self, nome_disciplina):

        colegas = ["Giulia", "Guilherme", "Bruno", "Franco"]
        colegas_cadastrados = [("Beilfus",), ("Carol",)]
        ...
        layout = [
            ...
            [sg.Text(nome_disciplina, font="bold",
                     justification="center", expand_x=True)],
            [sg.Text("Número de Membros*", size=(13, 1)), sg.InputText(None,
    ...
    def abrir(self, nome_disciplina):
        self.inicializar_componentes(nome_disciplina)
